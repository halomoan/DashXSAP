sap.ui.define([
	...
	jQuery.sap.declare("sap.ui.dashxsap.controller.chart03");
	return Controller.extend("sap.ui.dashxsap.controller.chart03", {
		...
		onInit: function(oThis,sId) {
            	...
            	var oVizFrame = this.oVizFrame = sap.ui.core.Fragment.byId(this.sChartType,"idVizFramechart03");
            	oVizFrame.setVizProperties(this.chartSettings);
	            var oPopOver = sap.ui.core.Fragment.byId(this.sChartType,"idPopOverchart03");
		...
		initChartSettings : function() {
            ...
            if (bSuiteAvailable) {
                ...
                var vizframe = sap.ui.core.Fragment.byId(this.sChartType,"idVizFramechart03");
                ...
                sap.ui.core.Fragment.byId(this.sChartType,"chartFixFlexchart03").setFlexContent(oChartContainer);
            }
        },
